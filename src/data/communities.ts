...
export const communities: Entry[] = [
  {
    ...
    tags: ['Operations', 'GTM'],
    icon: '🇰🇷',
    cover: '/photos/covers/ku-nus-founder-mixer.webp',
  ...
  },
  {
    ...
    tags: ['Operations', 'GTM'],
    icon: '🎤',
    cover: '/photos/covers/collective-pitch-night.webp',
  ...
  },
  {
    ...
    icon: '🤝',
    logo: '/logos/nus.png',
    cover: '/photos/covers/founders-across-campus.webp',
  ...
  },
  {
    ...
    icon: '🌏',
    logo: '/logos/nus.png',
    cover: '/photos/covers/noc-idp-sharing.webp',
